  ...
  return (
    <div className="details">
      {isLoading ? (
        ...
        <>
          <header>
            <button className="btn-pack" onClick={onCloseMovie}>
              &larr;
            </button>
          ...
          <section>
            <div className="rating">
              {!isWatched ? (
                ...
                <p>
                  You have already watched this, you rated {watchedUserRating}⭐
                </p>
              )}
            </div>
            <p>
    ...
    function () {
      ...
      async function fetchMovies() {
        try {
          ...
          // console.log(res);
          if (!res.ok) throw new Error("Somthing went wrong getting movies!!");
          // console.log(res);
          const data = await res.json();
          // console.log(data);
